    ...
    if ($style == 'style1') {
        ...
        $tableHTML .= '</div></div>';
            ...
            $tableHTML .= '<div class="visitors-wrapper">
                                <span class="review-visitors"><span>2143</span> people visited this site today
            ...
            $tableHTML .= '<div class="cpm-ajax-info cpm-advertiser-disclosure">
                                <button class="cpm-ajax-info-btn">ⓘ Advertiser Disclosure</button>
                            </div>
                        </div>';
            ...
            foreach ($newOffersArray as $arr_key => $offer) {
                ...
                $tableHTML .= '<div class="review-rating inner-container">
                                    <div class="cr-rating-stars" style="width: 100px; height: 20px; background-size: 20px;">
                                        <div class="fill" style="width: ' . esc_attr(($userRating / 10) * 100) . '%; height: 100%; background-size: 20px;"></div>
                                    </div> ' . number_format($userRating, 1) . '/10 rating
                                </div>';
                $tableHTML .= '<div class="review-score inner-container">
                                    <div class="score-box">
                                        <div class="cr-rating-number">' . number_format($userRating, 1) . '</div> 
                                        <span class="our-score">Our score</span> 
                                        <span class="text-score">Outstanding</span>
                                    </div>
                                    <div class="cr-rating-stars" style="width: 100px; height: 20px; background-size: 20px;">
                                        <div class="fill" style="width: ' . esc_attr(($userRating / 10) * 100) . '%; height: 100%; background-size: 20px;"></div>
                                    </div>
